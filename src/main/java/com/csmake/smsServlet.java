 ...
 */
@WebServlet(name = "com.csmake.sms", urlPatterns = {"/com.csmake.sms/*"}, loadOnStartup=1)
public class smsServlet extends HttpServlet{
    ...
    public void init() {
        ...
        if (com.csmake.sms.class.isAnnotationPresent(javax.inject.Singleton.class))
        {
            try{
                m = com.csmake.sms.class.getDeclaredMethod("Singleton");
                if (m != null)
                {
                    proxy = (com.csmake.sms) m.invoke(null);
                }
            }
            catch (Exception ex)
            {
        ...
        if (proxy == null){
            proxy = new com.csmake.sms();
        }
        _maps.put("com.csmake.sms", new com.csmake.GuidObject(proxy));
        try{
            m = com.csmake.sms.class.getDeclaredMethod("csmakeInit", _params.getClass());
            if (m != null){
                _params.remove("guid");
                _params.put("guid", "com.csmake.sms");
    ...
    throws ServletException, IOException
    {
        try
        {
            ...
            else if(url.contains("/file/"))
            {
                ...
                Document file = null;
                java.lang.reflect.Method m = com.csmake.sms.class.getDeclaredMethod("csmakeGetFile", org.bson.Document.class);
                if (m != null)
                {
                    ...
                    file = (Document) m.invoke(_maps.get("com.csmake.sms").getObject(), prop);
    ...
    */
        ...
        try{
            ...
            switch (cmd)
            {
                case "file":
                {
                    ...
                    try
                    {
                        java.lang.reflect.Method m = com.csmake.sms.class.getDeclaredMethod("csmakeSaveFile", byte[].class, org.bson.Document.class);
                        if (m != null)
                        {
                                ...
                                try
                                {
                                    while ((part = mp.readNextPart()) != null)
                                    {
                                        ...
                                        else if (part.isFile())
                                        {
                                            ...
                                            String ret = (String) m.invoke(com.csmake.sms.Singleton(), org.apache.commons.io.IOUtils.toByteArray(filePart.getInputStream()), prop);
                                            out.println(ret);
                                            out.flush();
                                            break;
                                        }
    ...
    private com.csmake.JSONReturn call(com.csmake.JSONCall context)
    {
        ...
        com.csmake.sms proxy = (com.csmake.sms)(guidObject!=null?guidObject.getObject():null);
        try
        {
            switch (context.symbol){
                case "constructor" :{ 
                    ...
                    if (single) {
                        guidObject = (com.csmake.GuidObject) _maps.get("com.csmake.sms");
                        if (guidObject != null) {
                            context.guid = "com.csmake.sms";
                        }
                    }
                    if (guidObject == null && clazz != null) {
                        ...
                        if (proxy == null) {
                            ...
                            proxy = (com.csmake.sms) con.newInstance();
                ...
                case "checked" :{ 
                    ...
                    retValue = proxy.checked(arg0);
                    break;
                }
                case "check" :{ 
                    String arg0 = (String)(context.args.get("0"));String arg1 = (String)(context.args.get("1"));
                    retValue = proxy.check(arg0, arg1);
                    break;
                }
                case "HTTP_POST" :{ 
                    String arg0 = (String)(context.args.get("0"));String arg1 = (String)(context.args.get("1"));
                    retValue = com.csmake.sms.HTTP_POST(arg0, arg1);
                    break;
                } 
                case "sendVerifyCode" :{ 
                    String arg0 = (String)(context.args.get("0"));int arg1 = (int)(context.args.get("1"));
                    retValue = proxy.sendVerifyCode(arg0, arg1);
                    break;
                }
                case "sendVerifyCode2" :{ 
                    String arg0 = (String)(context.args.get("0"));String arg1 = (String)(context.args.get("1"));int arg2 = (int)(context.args.get("2"));
                    retValue = proxy.sendVerifyCode(arg0, arg1, arg2);
                    break;
                } 
                case "set_guid" :{
            ...
            if(ex instanceof com.csmake.InvokeException){
                ...
                if(context.symbol.startsWith("constructor")){
                    ...
                    exception="com.csmake.sms is null pointer.";
                }else{
                    exception = ex.toString();
                }
            }
